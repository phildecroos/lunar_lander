...
explosion_medium = pygame.image.load(os.path.join(current_path, 'explosion_medium.png'))
in_air_explosion_large = pygame.image.load(os.path.join(current_path, 'in_air_explosion_large.png'))
player_thrusting = pygame.image.load(os.path.join(current_path, 'player_thrusting.png'))
...
class GameObject:
    def __init__(self, x, y, x_speed, y_speed, name):
        self.image = pygame.image.load(os.path.join(current_path, name + ".png"))
        self.x = x
        self.y = y
